                                ...
                                for (let i = 0; i < attributes.length; i++) {
                                  ...
                                  if (item) {
                                    if (item.name) {
                                      ...
                                      const cond_4 = item.name !== config.temporarily.id;
                                      const cond_5 = item.name !== native.dark.attribute.theme;
                                      //
                ...
                "color": function (e) {
                  if (e) {
                    try {
                      e = e.toLowerCase();
                      /*  */
                      if (e.indexOf("-gradient") !== -1) return config.native.remove.background.color;
                      if (e.indexOf("--") !== -1) return true;
                      //
                      if (e.indexOf("none") === -1) {
                        if (e.indexOf("unset") === -1) {
          ...
          "for": {
            ...
            "border": function (rule) {
              if (rule.style) {
                ...
                var b = config.native.force.width.border ? rule.style.getPropertyValue("outline-width") || rule.style.outlineWidth : true;
                /*  */
                if (((a && b) || c) && config.native.force.color.border) {
                  var tmp = c ? c : a;
                ...
                var b = config.native.force.width.border ? rule.style.getPropertyValue("border-width") || rule.style.borderWidth : true;
                /*  */
                if (((a && b) || c) && config.native.force.color.border) {
                  var tmp = c ? c : a;
                  if (tmp && tmp !== "var(--native-dark-border-color)") {
                ...
                var b = config.native.force.width.border ? rule.style.getPropertyValue("border-top-width") || rule.style.borderTopWidth : true;
                /*  */
                if (((a && b) || c) && config.native.force.color.border) {
                  var tmp = c ? c : a;
                  if (tmp && tmp !== "var(--native-dark-border-color)") {
                ...
                var b = config.native.force.width.border ? rule.style.getPropertyValue("border-left-width") || rule.style.borderLeftWidth : true;
                /*  */
                if (((a && b) || c) && config.native.force.color.border) {
                  var tmp = c ? c : a;
                  if (tmp && tmp !== "var(--native-dark-border-color)") {
                ...
                var b = config.native.force.width.border ? rule.style.getPropertyValue("border-right-width") || rule.style.borderRightWidth : true;
                /*  */
                if (((a && b) || c) && config.native.force.color.border) {
                  var tmp = c ? c : a;
                  if (tmp && tmp !== "var(--native-dark-border-color)") {
                ...
                var b = config.native.force.width.border ? rule.style.getPropertyValue("border-bottom-width") || rule.style.borderBottomWidth : true;
                /*  */
                if (((a && b) || c) && config.native.force.color.border) {
                  var tmp = c ? c : a;
                  if (tmp && tmp !== "var(--native-dark-border-color)") {
                  ...
                  const selector = text.split(',').map(e => {
                    ...
                    if (cond_1 || cond_2) {
                      ...
                      if (cond_5) {
                        ...
                        return keyglobal + (cond_8 ? (cond_5 ? '' : " ") : " ") + selectortext;
                      } else {
                        return keyglobal + " " + selectortext;
                      }
                    }
