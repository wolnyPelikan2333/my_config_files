...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js!./src/popup/css1.less
var css1 = __webpack_require__(575);
;// CONCATENATED MODULE: ./src/popup/css1.less
...
var update = injectStylesIntoStyleTag_default()(css1/* default */.Z, options);




       /* harmony default export */ const popup_css1 = (css1/* default */.Z && css1/* default.locals */.Z.locals ? css1/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/lodash/lodash.js
var lodash = __webpack_require__(486);
;// CONCATENATED MODULE: ./src/popup/languages.ts
...
;// CONCATENATED MODULE: ./src/utils/chrome.ts
...
var getTabCurrent = function () { return __awaiter(void 0, void 0, void 0, function () {
    var tab;
...
var socials = [
    ...
    },
    {
        ...
        title: 'Facebook',
        urlShare: "http://www.facebook.com/sharer/sharer.php?u=",
    },
    {
    ...
    },
    {
        ...
        title: 'VK',
        urlShare: "https://vk.com/share.php?redir=1&url=",
    },
    {
        ...
        title: 'OK',
        urlShare: "https://connect.ok.ru/dk?st.cmd=WidgetSharePreview&service=odnoklassniki&st.shareUrl=",
    },
    {
    ...
    },
    {
        ...
        title: 'Blogger',
        urlShare: "https://www.blogger.com/blog-this.g?u=",
    },
    {
        ...
        title: 'Tumblr',
        urlShare: "http://www.tumblr.com/share/link?url=",
    },
    {
        ...
        title: 'LinkedIn',
        urlShare: "https://www.linkedin.com/sharing/share-offsite/?url=",
    },
    {
        ...
        title: 'Mix',
        urlShare: "https://mix.com/add?url=",
    },
];
/* harmony default export */ const popup_share = (socials);
...
var sendMess = function (type, tabId) {
...
function Popup() {
    var _a = (0,react.useState)(''), select = _a[0], setSelectLanguage = _a[1];
    var _b = (0,react.useState)(), tabCurrent = _b[0], setTabCurrent = _b[1];
    var _c = (0,react.useState)(popup_share[2]), share = _c[0], setShare = _c[1];
    var _d = (0,react.useState)(false), isNotYoutube = _d[0], setIsNotYoutube = _d[1];
    var _e = (0,react.useState)(), alert = _e[0], setAlert = _e[1];
    var _f = (0,react.useState)(false), isFbLogin = _f[0], setIsFbLogin = _f[1];
    var _g = (0,react.useState)(false), isLiLogin = _g[0], setIsLiLogin = _g[1];
    var _h = (0,react.useState)(false), isTwLogin = _h[0], setIsTwLogin = _h[1];
    function onClickWholePage() {
        sendMess('translate-whole-page', tabCurrent.id);
    }
    function onClickStartTrans() {
        sendMess('translate-single-element', tabCurrent.id);
    }
    function onClickDefYouTube() {
        chrome.runtime.sendMessage({
            type: 'translate-youtube-caption',
            tabId: tabCurrent.id,
        });
    }
    function onChangeLanguage(e) {
        setSelectLanguage(e.target.value);
        chrome.storage.sync.set({ storedLanguage: e.target.value });
    }
    function checkAlert(value) {
        if (value === void 0) { value = share.title; }
        switch (value) {
            case 'Facebook':
                if (isFbLogin)
                    setAlert(undefined);
                else
                    setAlert('You note logged Facebook');
                break;
            case 'Twitter':
                if (isTwLogin)
                    setAlert(undefined);
                else
                    setAlert('You note logged Twitter');
                break;
            case 'LinkedIn':
                if (isLiLogin)
                    setAlert(undefined);
                else
                    setAlert('You note logged LinkedIn');
                break;
            default:
                setAlert(undefined);
                break;
    ...
    function onChangeShare(e) {
        var socail = (0,lodash.find)(popup_share, function (o) { return o.title === e.target.value; });
        setShare(socail);
        checkAlert(e.target.value);
    }
    function onShare() {
        window.open("".concat(share.urlShare).concat(tabCurrent.url), '_blank');
    }
    function checkSocial() {
        chrome.runtime.sendMessage({ type: 'checkSocial' }).then(function (r) {
            if (r) {
                setIsFbLogin(r === null || r === void 0 ? void 0 : r.fb);
                setIsTwLogin(r === null || r === void 0 ? void 0 : r.tw);
                setIsLiLogin(r === null || r === void 0 ? void 0 : r.li);
            }
        });
    }
    (0,react.useEffect)(function () {
        checkAlert();
    }, [isLiLogin, isTwLogin, isFbLogin]);
    function getStoredSettings() {
        chrome.storage.sync.get(['storedLanguage', 'darkcheckstatus'], function (settings) {
            if (settings.storedLanguage) {
                setSelectLanguage(settings.storedLanguage);
            }
            if (!settings.darkcheckstatus) {
                document.body.id = 'body';
            }
            else if (settings.darkcheckstatus) {
    ...
    (0,react.useEffect)(function () {
        getStoredSettings();
        checkSocial();
        getTabCurrent().then(function (tab) {
            if (tab) {
                setTabCurrent(tab);
                if (tab.url.match(/^https:\/\/www.youtube.com\/watch/g)) {
                    setIsNotYoutube(true);
                }
            }
        });
    }, []);
    return (react.createElement(react.Fragment, null,
        react.createElement("p", { className: 'title-popup' }, "Ultimate Video Translator (D-Click To Translate)"),
        react.createElement("p", { style: { fontSize: 12, paddingLeft: 3 } }, "Click Start button and then double-click or (Ctrl-key and left-click) on any element to translate it."),
        react.createElement("div", { className: "Row" },
            react.createElement("select", { className: "Column", value: select, onChange: onChangeLanguage, id: "selectedLanguage" },
                react.createElement("option", { value: "" }),
                languages.map(function (i) { return (react.createElement("option", { key: i.value, value: i.value }, i.label)); })),
            react.createElement("div", { className: "divc Column" },
                react.createElement("a", { onClick: onClickStartTrans, id: "Translate-Single-Element", href: "#", className: "action-button blue" }, "Start"))),
        react.createElement("a", { onClick: onClickWholePage, id: "Translate-Whole-Page", href: "#", className: "action-whole" }, "Translate the whole page"),
        ...
        react.createElement("p", { style: { fontSize: 12, paddingLeft: 3 } }, "Choose your language and click on Translate Youtube Caption."),
        react.createElement("div", { className: "divd" },
            react.createElement("a", { onClick: onClickDefYouTube, id: "Translate-Youtube-Caption", href: "#", className: "action-button2 blue" }, "Translate Youtube Caption")),
        react.createElement("div", { className: "line" }),
        react.createElement("label", { style: {
                fontSize: 15,
                color: '#539ff7',
        ...
        react.createElement("div", { className: "Row" },
            react.createElement("select", { className: "Column", defaultValue: 'Twitter', onChange: onChangeShare }, popup_share.map(function (i) { return (react.createElement("option", { key: i.title, value: i.title }, i.title)); })),
            react.createElement("div", { className: "divc Column" },
                react.createElement("a", { onClick: onShare, id: "Translate-Single-Element", href: "#", className: "action-button blue btn-share ".concat(isNotYoutube && !alert ? '' : 'disabled') }, "Share"))),
        alert && react.createElement("div", { className: 'alert' },
            "*",
            alert)));
}
...
var domRoot = document.getElementById('popup');
if (domRoot) {
