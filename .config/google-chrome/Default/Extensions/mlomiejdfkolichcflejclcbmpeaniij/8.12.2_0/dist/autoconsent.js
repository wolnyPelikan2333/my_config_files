typeof browser<"u"&&(chrome=browser),(()=>{var X1={86782:(S,L,s)=>{var t={"./card.js":43730,"./header.js":58489};function v(y){var l=k(y);return s(l)}function k(y){if(!s.o(t,y)){var l=new Error("Cannot find module '"+y+"'");throw l.code="MODULE_NOT_FOUND",l}return t[y]}v.keys=function(){return Object.keys(t)},v.resolve=k,S.exports=v,v.id=86782},72782:(S,L,s)=>{var t={"./confirm.js":44915,"./home.js":18589,"./main.js":57269};function v(y){var l=k(y);return s(l)}function k(y){if(!s.o(t,y)){var l=new Error("Cannot find module '"+y+"'");throw l.code="MODULE_NOT_FOUND",l}return t[y]}v.keys=function(){return Object.keys(t)},v.resolve=k,S.exports=v,v.id=72782},23998:(S,L,s)=>{var t={"./action.js":49111,"./button.js":69092,"./icon.js":29810,"./line.js":38191,"./onboarding-state.js":62788,"./text.js":86561,"./tooltip.js":89247,"./tracker-wheel.js":62254};function v(y){var l=k(y);return s(l)}function k(y){if(!s.o(t,y)){var l=new Error("Cannot find module '"+y+"'");throw l.code="MODULE_NOT_FOUND",l}return t[y]}v.keys=function(){return Object.keys(t)},v.resolve=k,S.exports=v,v.id=23998},43730:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={render:()=>t.dy`
    ...
    `}},58489:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={render:()=>t.dy`
  ...
  `}},44915:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>E});var t=s(77540),v=s(72020),k=s(67132),y=s(9300);function l(u){(0,t.WI)(u,"closeiframe",{bubbles:!0,detail:{reload:u.enabled}})}const E={enabled:!1,content:({enabled:u})=>v.dy`
  ...
  `}},18589:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>u});var t=s(77540),v=s(9300),k=s(72020),y=s(44915);const l=new URLSearchParams(window.location.search).get("default");function E(f){return T=>{(0,t.WI)(T,f,{bubbles:!0,detail:{all:T.scope==="all"}})}}const u={[v.Z.connect]:{stack:[y.default]},scope:l==="all"?"all":"selected",content:({scope:f})=>k.dy`
    <template layout="column margin:3 gap:4">
  ...
  `}},57269:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>u});var t=s(77540),v=s(9300),k=s(72020),y=s(67132),l=s(18589);function E(f,T){(0,t.WI)(f,"close",{detail:{reload:T.detail.reload}}),f.parentElement.removeChild(f)}const u={tag:"ui-autoconsent",stack:(0,v.Z)([l.default]),categories:{get:(f,T=[])=>T,set:(f,T)=>T||[]},content:({stack:f,categories:T})=>k.dy`
    <template layout="grid::min|1|min">
      <ui-autoconsent-card oncloseiframe="${E}">
        <ui-autoconsent-header></ui-autoconsent-header>
        ${f}
      </ui-autoconsent-card>
      ${v.Z.active(l.default)&&k.dy`
  ...
  `}},49111:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={render:()=>t.dy`
  ...
  `}},69092:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={type:"primary",size:"",disabled:!1,render:({size:k})=>t.dy`<slot></slot>`.css`
      :host {
   ...
   `}},29810:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={name:"",color:"",render:({name:y,color:l})=>t.dy`
  ...
  `}},38191:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={color:"gray-200",render:({color:k})=>t.dy`
    <template layout="block height:1px shrink:0"></template>
  `.css`
    :host {
      background: var(--ui-color-${k});
    }
  `}},62788:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={disabled:!1,href:"",render:({disabled:k,href:y})=>t.dy`
    <template
  ...
  `}},86561:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>v});var t=s(72020);const v={type:"body-m",mobileType:"",color:"",ellipsis:!1,underline:!1,render:({type:k,mobileType:y,color:l})=>t.dy`<slot></slot>`.css`
    :host {
      display: block;
  ...
  `}},89247:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>y});var t=s(72020);const v=new WeakMap;let k=null;const y={autohide:2,wrap:!1,position:"top",show:{value:!1,connect:l=>()=>clearTimeout(v.get(l)),observe:(l,E)=>{const u=l.render().querySelector("#tooltip");if(u.hidden=!E,u.style.transform="",E){k&&k!==l&&(k.show=!1),k=l;const{left:f,width:T}=u.getBoundingClientRect(),H=f+T+8-window.innerWidth,j=f-8;H>0?u.style.transform=`translateX(calc(-50% - ${H}px)`:j<0&&(u.style.transform=`translateX(calc(-50% + ${Math.abs(j)}px)`),l.autohide&&v.set(l,setTimeout(()=>{l.show=!1},l.autohide*1e3))}else clearTimeout(v.get(l))}},render:({position:l})=>t.dy`
    <template layout="contents">
      <div
  ...
  `}},62254:(S,L,s)=>{"use strict";s.r(L),s.d(L,{default:()=>E});var t=s(72020),v=s(4182),k=s(56570);function y(u,f){const{clientX:T,clientY:H}=f,{left:j,top:X}=u.getBoundingClientRect(),o1=T-j,b=H-X;u.tooltip.style.left=`${o1}px`,u.tooltip.style.top=`${b}px`}function l(u){return(f,T)=>T===u?f+1:f}const E={categories:void 0,data:({categories:u=[]})=>{if(!u.length)return[["",{value:100,offset:0}]];const f=u.reduce((b,_)=>{const g=b.get(_)||0;return b.set(_,g+1),b},new Map);let T=u.length;const H=4,j=[];f.forEach((b,_)=>{b/T<=H/100&&j.push(_)});const X=T/(100/H-j.length);j.forEach(b=>{const _=f.get(b);f.set(b,X),T+=X-_});let o1=0;return f.forEach((b,_)=>{b=Math.max(b/T*100-H,0),f.set(_,{value:b,offset:o1}),o1+=(b+H)*360/100}),[...f.entries()]},current:"",tooltip:({render:u})=>u().querySelector("ui-tooltip"),render:({categories:u,data:f,current:T})=>t.dy`
  ...
  `.css`
   ...
   `}},9664:(S,L,s)=>{"use strict";var t=s(67132);typeof chrome=="object"&&chrome.i18n&&(0,t.NC)(chrome.i18n.getMessage.bind(chrome.i18n),{format:"chrome.i18n"})},4182:(S,L,s)=>{"use strict";s.d(L,{BJ:()=>E,EQ:()=>y});const t={advertising:"#CB55CD",site_analytics:"#5EBEDB",consent:"#556FCD",essential:"#FC9734",hosting:"#8459A5",customer_interaction:"#EF671E",unidentified:"#79859E",audio_video_player:"#4ECB4E",cdn:"#4ECBA1",comments:"#4EA1CB",email:"#4E4ECB",extensions:"#A14ECB",misc:"#CB4EA1",pornvertising:"#CB4E4E",social_media:"#CBA14E",telemetry:"#A1CB4E",other:"#D5DBE5"},v={...t,site_analytics:"#87D7EF",unidentified:"#DBDFE7"},k=null;function y(f){return t[f]?f:"unidentified"}function l(f){return t[y(f)]}function E(f){return v[y(f)]}function u(f=T=>T){return(T,H)=>{const j=y(f(T)),X=y(f(H));return k.indexOf(j)-k.indexOf(X)}}},56570:(S,L,s)=>{"use strict";s.d(L,{b:()=>k});var t=s(67132),v=s(9664);const k={advertising:t.WI`Advertising | Tracker category name`,site_analytics:t.WI`Site Analytics | Tracker category name`,consent:t.WI`Consent Management | Tracker category name - includes trackers used for cookie consent management, allowing websites different levels of tracking user activity`,essential:t.WI`Essential | Tracker category name`,hosting:t.WI`Hosting | Tracker category name`,customer_interaction:t.WI`Customer Interaction | Tracker category name`,unidentified:t.WI`Unidentified | Tracker category name`,audio_video_player:t.WI`Audio/Video Player | Tracker category name`,cdn:t.WI`CDN | Tracker category name`,comments:t.WI`Comments | Tracker category name`,email:t.WI`Email | Tracker category name`,extensions:t.WI`Extensions | Tracker category name`,misc:t.WI`Miscellaneous | Tracker category name`,pornvertising:t.WI`Adult Advertising | Tracker category name`,social_media:t.WI`Social Media | Tracker category name`,telemetry:t.WI`Telemetry | Tracker category name`,other:t.WI`Other | Tracker category name`}},96806:(S,L,s)=>{"use strict";s.d(L,{N7:()=>H,NE:()=>_,U2:()=>f,t8:()=>T,z6:()=>b});var t=s(17337);const v=new WeakMap,k=new Set;function y(g){const p=new Set,d=p.values();for(;g;){if(g.resolved=!1,g.deps){for(const r of g.deps)r.contexts.delete(g);g.deps.clear()}if(g.contexts)for(const r of g.contexts)k.has(r)||(p.add(r),g.contexts.delete(r));g.observe&&t.I(g.observe),g=d.next().value}}function l(g,p){let d=v.get(g);d||(d=new Map,v.set(g,d));let r=d.get(p);return r||(r={key:p,target:g,value:void 0,lastValue:void 0,resolved:!1,contexts:void 0,deps:void 0,observe:void 0},d.set(p,r)),r}function E(g){const p=v.get(g);return p?[...p.values()]:[]}let u=null;function f(g,p,d){const r=l(g,p);if(u&&(r.contexts||(r.contexts=new Set),u.deps||(u.deps=new Set),r.contexts.add(u),u.deps.add(r)),r.resolved)return r.value;const c=u;try{if(k.has(r))throw Error(`Circular get invocation is forbidden: '${p}'`);u=r,k.add(r),r.value=d(g,r.value),r.resolved=!0,u=c,k.delete(r)}catch(V){throw u=c,k.delete(r),u&&(u.deps.delete(r),r.contexts.delete(u)),V}return r.value}function T(g,p,d,r){const c=l(g,p),V=d(g,r,c.value);V!==c.value&&(c.value=V,y(c))}function H(g,p,d,r){const c=l(g,p);c.observe=()=>{const V=f(g,p,d);V!==c.lastValue&&(r(g,V,c.lastValue),c.lastValue=V)};try{c.observe()}catch(V){console.error(V)}return()=>{t.Z(c.observe),c.observe=void 0,c.lastValue=void 0}}const j=new Set;function X(g){j.size||setTimeout(()=>{for(const p of j)if(!p.contexts||p.contexts.size===0){if(p.deps)for(const r of p.deps)r.contexts.delete(p);v.get(p.target).delete(p.key)}j.clear()}),j.add(g)}function o1(g,p){y(g),p.clearValue&&(g.value=void 0,g.lastValue=void 0),p.deleteEntry&&X(g)}function b(g,p,d={}){const r=l(g,p);o1(r,d)}function _(g,p={}){const d=v.get(g);if(d)for(const r of d.values())o1(r,p)}},90384:(S,L,s)=>{"use strict";s.d(L,{A:()=>E,Z:()=>o1});var t=s(96806),v=s(17337),k=s(77540),y=s(43945),l=s(13436);const E=new WeakMap,u=new WeakMap;function f(b,_){if(_){const r=E.get(_);if(b===r)return _;for(const c of Object.keys(r))c!=="tag"&&delete _.prototype[c]}else _=class extends globalThis.HTMLElement{connectedCallback(){for(const c of _.settable){if(!hasOwnProperty.call(this,c))continue;const V=this[c];delete this[c],this[c]=V}const r=new Set;u.set(this,r),v.I(()=>{if(r===u.get(this)){for(const c of _.connects)r.add(c(this));for(const c of _.observers)r.add(c(this))}})}disconnectedCallback(){const r=u.get(this);for(const c of r)c&&c();u.delete(this),t.NE(this)}};E.set(_,Object.freeze(b));const g=new Set,p=new Set,d=new Set;for(const r of Object.keys(b)){if(r==="tag")continue;let c=b[r];const V=typeof c;if(V==="function")r==="render"?c=(0,y.Z)(c,!0):r==="content"?c=(0,y.Z)(c):c={get:c};else if(V!=="object"||c===null)c={value:c};else if(c.set){if(hasOwnProperty.call(c,"value"))throw TypeError(`Invalid property descriptor for '${r}' property - it must not have 'value' and 'set' properties at the same time.`);const K=(0,k.Dk)(r),t1=c.get||((C1,Q)=>Q);c.get=(C1,Q)=>(Q===void 0&&(Q=c.set(C1,C1.getAttribute(K)||Q)),t1(C1,Q))}if(hasOwnProperty.call(c,"value"))c=(0,l.Z)(r,c);else if(!c.get)throw TypeError(`Invalid descriptor for '${r}' property - it must contain 'value' or 'get' option`);c.set&&d.add(r),Object.defineProperty(_.prototype,r,{get:function(){return t.U2(this,r,c.get)},set:c.set&&function(t1){t.t8(this,r,c.set,t1)},enumerable:!0,configurable:!0}),c.connect&&g.add(K=>c.connect(K,r,()=>{t.z6(K,r)})),c.observe&&p.add(K=>t.N7(K,r,c.get,c.observe))}return _.connects=g,_.observers=p,_.settable=d,_}const T=new Map;function H(b){T.size||k.gX.then(()=>{(0,k.N7)(globalThis.document.body,_=>{if(T.has(_.constructor)){const g=T.get(_.constructor),p=E.get(_.constructor);_.disconnectedCallback();for(const d of Object.keys(p)){const r=typeof p[d],c=r!=="object"&&r!=="function"&&p[d]!==g[d];c&&_.removeAttribute((0,k.Dk)(d)),t.z6(_,d,{clearValue:c})}_.connectedCallback()}}),T.clear()}),T.set(b,E.get(b))}function j(b){if(!b.tag)throw TypeError("Error while defining hybrids: 'tag' property with dashed tag name is required");const _=globalThis.customElements.get(b.tag);if(_){if(E.get(_))return H(_),f(b,_),b;throw TypeError(`Custom element with '${b.tag}' tag name already defined outside of the hybrids context`)}return globalThis.customElements.define(b.tag,f(b)),b}function X(b,{root:_="",prefix:g}={}){for(const p of Object.keys(b)){const d=b[p];if(!d.tag){const r=(0,k.Dk)([].concat(_).reduce((c,V)=>c.replace(V,""),p).replace(/^[./]+/,"").replace(/\//g,"-").replace(/\.[a-zA-Z]+$/,""));d.tag=g?`${g}-${r}`:r}j(d)}return b}const o1=Object.freeze(Object.assign(j,{compile:b=>f(b),from:X}))},17337:(S,L,s)=>{"use strict";s.d(L,{I:()=>k,Z:()=>y});var t=s(77540);const v=new Set;function k(E){v.size||t.gX.then(l),v.add(E)}function y(E){v.delete(E)}function l(){for(const E of v)try{E()}catch(u){console.error(u)}v.clear()}},67132:(S,L,s)=>{"use strict";s.d(L,{NC:()=>o1,U2:()=>j,WI:()=>g,eL:()=>f});var t=s(58768),v=s(77540),k=s(72020);const y=new Map,l=new Map;let E=null;const u=(()=>{let p;try{p=globalThis.navigator.languages||[globalThis.navigator.language]}catch{p=[]}return p.reduce((d,r)=>{const c=r.split("-")[0];return d.add(r),r!==c&&d.add(c),d},new Set)})();function f(){return E!==null||y.size}function T(){u.delete("default"),y.clear(),l.clear(),E=null}const H=new Map;function j(p,d,r=[]){p=p.trim().replace(/\s+/g," "),d=d.trim();const c=`${p} | ${d}`;let V=l.get(c);if(!V){if(y.size)for(const K of u){const t1=y.get(K);if(t1&&(V=t1[c]||t1[p],V)){if(V=V.message,typeof V=="object"){let C1=H.get(K);C1||(C1=new Intl.PluralRules(K),H.set(K,C1));const Q=V;V=E1=>E1===0&&Q.zero||Q[C1.select(E1)]||Q.other||""}break}}V||(E&&(V=E(p,d)),V||(V=p,(y.size||E)&&v.$H&&console.warn(`Missing translation: "${p}"${d?` [${d}]`:""}`))),l.set(c,V)}return typeof V=="function"?V(r[0]):V}function X(p){return p.replace("$","@").replace(/[^a-zA-Z0-9_@]/g,"_").toLowerCase()}function o1(p,d){switch(typeof p){case"function":{if((d||{}).format==="chrome.i18n"){const c=new Map;E=(V,K)=>{V=K?`${V} | ${K}`:V;let t1=c.get(V);return t1||(t1=X(V),c.set(V,t1)),p(t1,K)}}else E=p;break}case"string":{if(!d||typeof d!="object")throw TypeError("Messages must be an object");p==="default"&&u.add("default");const r=y.get(p)||{};y.set(p,{...r,...d});break}default:throw TypeError("The first argument must be a string or a function")}}Object.defineProperty(o1,"languages",{get:()=>Array.from(u)});function b(p,d){let r="";for(const[K,t1]of p.entries())r+=K?`\${${K-1}}${t1}`:t1;const[c,,V=""]=r.split("|");return j(c,V,d)}const _=/\$\{(\d+)\}/g;function g(p,...d){return b(p,d).replace(_,(r,c)=>d[c])}g.html=function(d,...r){const c=b(d,r);return(0,k.MY)(c.replace(_,(V,K)=>(0,t.ph)(K)),r,!1,!0)},g.svg=function(d,...r){const c=b(d,r);return(0,k.MY)(c.replace(_,(V,K)=>(0,t.ph)(K)),r,!0,!0)}},43945:(S,L,s)=>{"use strict";s.d(L,{Z:()=>t});function t(v,k){return{get:k?y=>{const l=v(y),E=y.shadowRoot||y.attachShadow({mode:"open",delegatesFocus:v.delegatesFocus||!1});return()=>(l(y,E),E)}:y=>{const l=v(y);return()=>(l(y,y),y)},observe(y,l){l()}}}},9300:(S,L,s)=>{"use strict";s.d(L,{Z:()=>j1});var t=s(96806),v=s(77540),k=s(90384);const y=Symbol("router.connect"),l=new WeakMap,E=new WeakMap,u=new WeakMap,f=new WeakMap;let T=null;const H=new Set;let j=!1;function X(i=!0){j=!!i}const o1=new WeakMap,b=new WeakMap;function _(i){const h=globalThis.document.activeElement;b.set(i,T.contains(h)&&h);const C=new Map;for(const w of[globalThis.document.documentElement,globalThis.document.body])C.set(w,{left:w.scrollLeft,top:w.scrollTop});(0,v.N7)(i,w=>{(w.scrollLeft||w.scrollTop)&&C.set(w,{left:w.scrollLeft,top:w.scrollTop})}),o1.set(i,C)}function g(i){if(i.tabIndex===-1){const h=i.style.outline;i.tabIndex=0,i.style.outline="none",i.addEventListener("blur",()=>{i.removeAttribute("tabindex"),i.style.outline=h},{once:!0})}i.focus({preventScroll:!0})}function p(i){const h=globalThis.document.activeElement;v.gX.then(()=>{g(b.get(i)||(T.contains(h)?h:T));const C=o1.get(i);if(C){const w=l.get(i),M=globalThis.history.state.find(D=>D.id===w.id),O=M&&M.params.scrollToTop;for(const[D,{left:P,top:B}]of C)D.scrollLeft=O?0:P,D.scrollTop=O?0:B;o1.delete(i)}else for(const w of[globalThis.document.documentElement,globalThis.document.body])w.scrollLeft=0,w.scrollTop=0;setTimeout(()=>{globalThis.history.scrollRestoration="auto"},0)})}function d(i){return i===!0?1:i||""}const r=["scrollToTop"];function c(i,h){const[C,w=""]=i.split("?"),$=w?w.split(","):[],M=C.replace(/^\//,"").split("/"),O=M.reduce((D,P)=>{if(P.startsWith(":")){const B=P.slice(1);if($.includes(B))throw Error(`The '${B}' already used in search params`);if(D.includes(B))throw Error(`The '${B}' already used in pathname`);D.push(B)}return D},[]);return{browserUrl:i,pathnameParams:O,paramsKeys:[...$,...O],url(D,P=!1){let B="";for(let N of M){if(N.startsWith(":")){const W=N.slice(1);if(!hasOwnProperty.call(D,W))throw Error(`The '${W}' parameter must be defined for <${h}>`);N=d(D[W])}B+=`/${N}`}const A=new URL(B,globalThis.location.origin);for(const N of Object.keys(D))O.includes(N)||P&&(r.includes(N)||!$.includes(N))||A.searchParams.append(N,d(D[N]));return A},match(D){const P={},B=D.pathname.replace(/^\//,"").split("/");if(B.length!==M.length)return null;for(let A=0;A<B.length;A+=1){const N=B[A],W=M[A];if(W.startsWith(":")){const a1=W.slice(1);P[a1]=N}else if(N!==W)return null}for(const[A,N]of D.searchParams)P[A]=N;return P}}}function V(i,h){return i.stack.some(C=>C===h?!0:V(C,h))}function K(i){i.browserUrl&&H.add(i);for(const h of i.stack)K(h)}function t1(i,h,C=null,w=null){return typeof i=="function"&&(i=i()),i=[].concat(i),i.map($=>{const M=l.get($);if(M&&V(M,C))throw Error(`<${M.id}> cannot be in the stack of <${C.id}>, as it is an ancestor in the stack tree`);return E1($,h,C,w)})}function C1(i,h){const C=Object.values(i).map(w=>f.get(w)).filter(w=>w);if(C.length){if(C.length>1)throw TypeError(`<${h.id}> must contain at most one nested router, found: ${C.length}`);if(h.dialog)throw TypeError(`Nested routers are not supported in dialogs. Remove the router property definition from <${h.id}>`);if(h.browserUrl)throw TypeError(`A view with nested router must not have the url option. Remove the url option from <${h.id}>`)}return C[0]}function Q(i){const h=globalThis.customElements.get(i);return l.get(h)}function E1(i,h,C,w){const $=i.tag;let M=Q($);if(M&&M.hybrids!==i&&(M=null),M)M.parent=C,M.nestedParent=w;else{const D=globalThis.customElements.get($);if(!D||k.A.get(D)!==i)throw Error(`<${$}> view must be defined by 'define()' function before it can be used in router factory`);let P=null;const B={dialog:!1,guard:!1,multiple:!1,replace:!1,...i[y]},{connects:A}=D;B.dialog&&A.add(R=>{const q=c1=>{c1.key==="Escape"&&(c1.stopPropagation(),globalThis.history.go(-1))},J=c1=>{!R.contains(c1.target)&&c1.target!==R&&g(R)},r1=T;return r1.addEventListener("focusin",J),r1.addEventListener("focusout",J),R.addEventListener("keydown",q),g(R),()=>{r1.removeEventListener("focusin",J),r1.removeEventListener("focusout",J),R.removeEventListener("keydown",q)}});const N=[];for(const R of Object.keys(D.prototype))Object.getOwnPropertyDescriptor(D.prototype,R).set&&N.push(R);if(B.url){if(B.dialog)throw Error(`The 'url' option is not supported for dialogs - remove it from <${$}>`);if(typeof B.url!="string")throw TypeError(`The 'url' option in <${$}> must be a string: ${typeof B.url}`);P=c(B.url,$);for(const R of P.paramsKeys){const q=Object.getOwnPropertyDescriptor(D.prototype,R);if(!q||!q.set)throw Error(`'${R}' parameter from the url is not ${q?"writable":"defined"} in <${$}>`)}}const W=N.filter(R=>!h.params.includes(R)&&!r.includes(R)),a1=P?W.filter(R=>!P.pathnameParams.includes(R)):W;A.add(R=>t.N7(R,y,q=>{const J={};for(const r1 of W){const c1=d(q[r1]).toString();J[r1]=c1!==void 0&&q[r1]!==i[r1]?String(c1):void 0}return J},(q,J,r1)=>{if(!r1)return;const c1=globalThis.history.state;let h1=c1[0];for(;h1.id!==$&&h1.nested;)h1=h1.nested;J={...h1.params,...J};for(const B1 of a1)J[B1]===void 0&&delete J[B1];globalThis.history.replaceState([M.getEntry(J),...c1.slice(1)],"",P?M.url(J,!0):"")}));let p1;if(B.guard&&(p1=()=>{try{return B.guard()}catch(R){return console.error(R),!1}}),M={id:$,hybrids:i,dialog:B.dialog,multiple:B.multiple,replace:B.replace,guard:p1,parent:C,nestedParent:w,nestedRoots:void 0,parentsWithGuards:void 0,stack:[],...P||{url(R){const q=new URL("",globalThis.location.origin);for(const J of Object.keys(R))q.searchParams.append(J,d(R[J]));return new URL(`${h.url}#@${$}${q.search}`,globalThis.location.origin)},match(R){const q={};for(const[J,r1]of R.searchParams)(N.includes(J)||r.includes(J))&&(q[J]=r1);return q}},create(){const R=new D;return l.set(R,M),R},getEntry(R={},q){let J={};for(const h1 of Object.keys(R))N.includes(h1)&&(J[h1]=R[h1]);const r1={id:$,params:J,...q},c1=M.parentsWithGuards.find(h1=>!h1.guard());if(c1)return c1.getEntry(R,{from:r1});if(M.guard&&M.guard())return{...M.stack[0].getEntry(R)};if(M.nestedParent)return M.nestedParent.getEntry(R,{nested:r1});for(const h1 of r)hasOwnProperty.call(R,h1)&&(r1.params[h1]=R[h1]);return r1}},l.set(i,M),l.set(D,M),C&&!C.stack.includes(M)&&C.stack.push(M),B.stack){if(B.dialog)throw Error(`The 'stack' option is not supported for dialogs - remove it from <${$}>`);t1(B.stack,h,M,w)}}for(C||K(M),M.parentsWithGuards=[];C;)C.guard&&M.parentsWithGuards.unshift(C),C=C.parent;const O=C1(i,M);return O&&(M.nestedRoots=t1(O.views,{...h,...O},M,M),M.stack=M.stack.concat(M.nestedRoots)),M}function D1(i,h={}){const C=l.get(i);return C?C.url(h):""}function H1(i){const h={};for(;i;)Object.assign(h,i.params),i=i.nested;return h}function A1({nested:i=!1,scrollToTop:h=!1}={}){const C=globalThis.history.state;if(!C)return"";if(C.length>1){const M=C[0];let O=1,D=C[O];if(i)for(;D.nested;)D=D.nested;else for(;M.id===D.id&&O<C.length-1;)O+=1,D=C[O];const P=H1(C[O]);return h?P.scrollToTop=!0:delete P.scrollToTop,Q(D.id).url(P)}let w=C[0];if(i)for(;w.nested;)w=w.nested;let $=Q(w.id).parent;if($){for(;$&&$.guard;)$=$.parent;if($)return $.url(H1(C[0]))}return""}function $1(i={}){const h=globalThis.history.state;if(!h)return"";const C=h[0];if(C.from)return Q(C.from.id).url({...C.from.params,...i});const w=Q(C.id);return w.stack[0]?w.stack[0].url(i):""}function S1(i){const h=globalThis.history.state;if(!h)return"";let C=h[0];for(;C.nested;)C=C.nested;return Q(C.id).url({...C.params,...i})}function N1(i,{stack:h=!1}={}){const C=globalThis.history.state;return C?(i=[].concat(i),i.some(w=>{const $=l.get(w);if(!$)throw TypeError(`Provided view is not connected to the router: ${w}`);let M=C[0];for(;M;){const O=Q(M.id);if(O===$||h&&V($,O))return!0;M=M.nested}return!1})):!1}function _1(i){let h;const[C,w]=i.hash.split("?");if(C&&C.match(/^#@.+-.+/)&&(h=Q(C.split("@")[1]),i=new URL(`?${w}`,globalThis.location.origin)),!h){for(const $ of H){const M=$.match(i);if(M)return $.getEntry(M)}return null}return h.getEntry(h.match(i))}function v1(i){if(i.defaultPrevented)return;let h;if(i.type==="click"){if(i.ctrlKey||i.metaKey)return;const C=i.composedPath().find(w=>w instanceof globalThis.HTMLAnchorElement);C&&(h=new URL(C.href,globalThis.location.origin))}else h=new URL(i.target.action,globalThis.location.origin);if(h&&h.origin===globalThis.location.origin){const C=_1(h);C&&(i.preventDefault(),(0,v.WI)(T,"navigate",{bubbles:!0,detail:{entry:C,url:h}}))}}let b1;function W1(i,h){i.preventDefault(),b1=h;const C=i.composedPath(),w={type:i.type,ctrlKey:i.ctrlKey,metaKey:i.metaKey,target:i.target,defaultPrevented:!1,preventDefault:()=>{},composedPath:()=>C};return h.then(()=>{h===b1&&(v1(w),b1=null)})}function Z1(i,h,C){let w=u.get(i);const $=[];for(const[P,B]of h.entries())(P===0||h[P-1].id!==B.id||Q(B.id).multiple)&&$.push(B);const M=w.length-$.length;w=$.map((P,B)=>{const A=w[B+M],N=Q(P.id);let W;if(A){const a1=l.get(A);if(N.id!==a1.id||B===0&&N.replace)return N.create();W=A}else W=N.create();return W}),u.set(i,w);const O=w[0],D=E.get(O);for(const[P,B]of Object.entries(h[0].params))P in O&&(O[P]=B);for(const P of C.params)P in O&&(O[P]=i[P]);return D&&D(),w}function R1(i){const h=[];for(let[$,M]of globalThis.history.state.entries()){let O=0;for(;M;)h[O]=h[O]||[],h[O][$]=M,M=M.nested,O+=1}let C=0,w=0;for(;i;){const $=Q(i.id);let M=C;for(;M<h[w].length;M+=1){const O=h[w][M];if($.dialog)return O.id!==i.id?-1:C;if(O.id===i.id)if($.multiple){if($.pathnameParams&&$.pathnameParams.every(P=>i.params[P]===O.params[P])||Object.entries(i.params).every(([P,B])=>O.params[P]===B)){C=M;break}}else{C=M;break}const D=Q(O.id);if(V(D,$)){if($.multiple&&h[w][0].id===i.id){C-=1;break}if(M>0){C=M-1;break}else return D.guard?0:-1}}M===h[w].length&&(C=h[w].length-1),i=i.nested,w+=1}return C}function L1(i,h){const C=globalThis.document.documentElement;if(!i){C.removeAttribute("router-transition");return}const{dialog:w}=l.get(i[0].constructor),$=w&&"dialog"||h.length&&(i.length>h.length&&"forward"||i.length<h.length&&"backward"||i[0]!==h[0]&&"replace")||"";C.setAttribute("router-transition",$)}function I1(i,h,C){function w(){const A=u.get(i),N=Z1(i,globalThis.history.state,C);C.transition&&L1(N,A),h();const W=N[0];l.get(W).dialog||p(W)}function $(A,N,W){const a1=globalThis.history.state,p1=globalThis.history.state[A],R=A<a1.length-1&&a1.length>2?1:0;A+=R,p1&&N.id===p1.id&&(N={...p1,...N});const q=J=>{J&&(globalThis.removeEventListener("popstate",q),globalThis.addEventListener("popstate",w));const r1=R?"pushState":"replaceState",c1=[N,...a1.slice(A+(R?0:1))];globalThis.history[r1](c1,"",W),w()};A?(globalThis.removeEventListener("popstate",w),globalThis.addEventListener("popstate",q),globalThis.history.go(-A)):q()}function M(A){const N=globalThis.history.state;let W=A;for(;W.nested;)W=W.nested;const a1=Q(W.id),p1=a1.browserUrl?a1.url(W.params,!0):C.url,R=R1(A);if(R>-1)$(R,A,p1);else{let q=u.get(i);_(q[0]),globalThis.history.scrollRestoration="manual",globalThis.history.pushState([A,...N],"",p1),w()}}function O(A){M(A.detail.entry)}if(T)throw Error(`An element with root router already connected to the document: <${T.tagName.toLowerCase()}>`);let D;try{D=t1(C.views,C),T=i,E.set(i,w)}catch(A){throw console.error(`Error while connecting router in <${i.tagName.toLowerCase()}>:`),A}const P=globalThis.history.state,B=new URL(globalThis.location.href);if(P){const A=u.get(i);let N;for(N=P.length-1;N>=0;N-=1){let W=P[N];for(;W;){const a1=Q(W.id);if(!a1||a1.dialog&&A.length===0||!D.includes(a1)&&!D.some(p1=>V(p1,a1)))break;W=W.nested}if(W)break}if(N>-1){const W=P[N+1];$(P.length-N-1,W||D[0].getEntry(P[0].params),C.url)}else{let W=P[0];for(;W.nested;)W=W.nested;const p1=Q(W.id).getEntry(W.params);M(p1)}}else{const A=_1(B)||D[0].getEntry();globalThis.history.replaceState([A],"",C.url),w()}return globalThis.addEventListener("popstate",w),i.addEventListener("click",v1),i.addEventListener("submit",v1),i.addEventListener("navigate",O),()=>{globalThis.removeEventListener("popstate",w),i.removeEventListener("click",v1),i.removeEventListener("submit",v1),i.removeEventListener("navigate",O),L1(null),H.clear(),T=null;const A=globalThis.history.state&&globalThis.history.state.length;A>1&&(globalThis.history.go(1-A),globalThis.history.replaceState(P,"",B))}}function O1(i,h,C){const w=l.get(i);function $(){return globalThis.history.state.map(O=>{for(;O;){if(O.id===w.id)return O.nested;O=O.nested}return O}).filter(O=>O)}function M(){Z1(i,$(),C),h()}if(!$()[0]){const O=globalThis.history.state;globalThis.history.replaceState([w.nestedRoots[0].getEntry(O[0].params),...O.slice(1)],"")}M(),E.set(i,M)}function P1(i,h){h={url:globalThis.location.href.replace(/#.*$/,""),params:[],...h,views:i};const C={get:w=>{const $=u.get(w)||[];return $.slice(0,$.findIndex(M=>!l.get(M).dialog)+1).reverse()},connect:(w,$,M)=>{for(const O of h.params)if(!(O in w))throw Error(`Property '${O}' for global parameters is not defined in <${w.tagName.toLowerCase()}>`);return u.has(w)||u.set(w,[]),l.has(w)?O1(w,M,h):I1(w,M,h)},observe:j&&((w,$,M)=>{const O=$.length-1,D=$[O];if(M&&D===M[O])return;let P=l.get(w),B=globalThis.history.state[0],A=0;for(;P;)A+=1,B=B.nested,P=P.nestedParent;console.groupCollapsed(`[${w.tagName.toLowerCase()}]: navigated to <${B.id}> ($$${A})`);for(const[N,W]of Object.entries(B.params))console.log(`%c${N}:`,"font-weight: bold",W);console.groupEnd(),global[`$$${A}`]=D})};return f.set(C,h),C}const j1=Object.freeze(Object.assign(P1,{connect:y,debug:X,url:D1,backUrl:A1,guardUrl:$1,currentUrl:S1,resolve:W1,active:N1}))},72020:(S,L,s)=>{"use strict";s.d(L,{MY:()=>U1,dy:()=>F1,YP:()=>G1});var t={};s.r(t),s.d(t,{resolve:()=>D,set:()=>N,transition:()=>a1});var v={};s.r(v),s.d(v,{css:()=>q,key:()=>p1,style:()=>R,use:()=>J});var k=s(77540),y=s(67132);const l=!!(globalThis.document&&globalThis.document.adoptedStyleSheets),E=/^\d+$/,u={block:(o,e)=>({display:"block","text-align":e}),inline:({display:o})=>({display:`inline${o?`-${o}`:""}`}),contents:{display:"contents"},hidden:{display:"none"},...["row","row-reverse","column","column-reverse"].reduce((o,e)=>(o[e]=(n,a="nowrap")=>({display:"flex","flex-flow":`${e} ${a}`}),o),{}),grow:(o,e=1)=>({"flex-grow":e}),shrink:(o,e=1)=>({"flex-shrink":e}),basis:(o,e)=>({"flex-basis":H(e)}),order:(o,e=0)=>({order:e}),grid:(o,e="1",n="",a="",x="")=>({display:"grid",...["columns","rows"].reduce((m,Z)=>{const z=Z==="columns"?e:n;return m[`grid-template-${Z}`]=z&&z.split("|").map(s1=>s1.match(E)?`repeat(${s1}, minmax(0, 1fr))`:H(s1)).join(" "),m},{}),"grid-auto-flow":`${a} ${x&&"dense"}`}),area:(o,e="",n="")=>({"grid-column":e.match(E)?`span ${e}`:e,"grid-row":n.match(E)?`span ${n}`:n}),gap:(o,e=1,n="")=>({"column-gap":H(e),"row-gap":H(n||e)}),items:(o,e="start",n="")=>({"place-items":`${e} ${n}`}),content:(o,e="start",n="")=>({"place-content":`${e} ${n}`}),self:(o,e="start",n="")=>({"place-self":`${e} ${n}`}),center:{"place-items":"center","place-content":"center"},size:(o,e,n=e)=>({width:H(e),height:H(n),"box-sizing":"border-box"}),width:(o,e,n,a)=>({width:H(e),"min-width":H(n),"max-width":H(a),"box-sizing":"border-box"}),height:(o,e,n,a)=>({height:H(e),"min-height":H(n),"max-height":H(a),"box-sizing":"border-box"}),ratio:(o,e)=>({"aspect-ratio":e}),overflow:(o,e="hidden",n="")=>{const a=n?`-${e}`:"",x=n||e;return{[`overflow${a}`]:x,...x==="scroll"?{"flex-grow":o["flex-grow"]||1,"flex-basis":0,"overscroll-behavior":"contain","--webkit-overflow-scrolling":"touch"}:{}}},margin:(o,e="1",n,a,x)=>e.match(/top|bottom|left|right/)?{[`margin-${e}`]:H(n||"1")}:{margin:`${H(e)} ${H(n)} ${H(a)} ${H(x)}`},padding:(o,e="1",n,a,x)=>e.match(/top|bottom|left|right/)?{[`padding-${e}`]:H(n||"1")}:{padding:`${H(e)} ${H(n)} ${H(a)} ${H(x)}`},absolute:{position:"absolute"},relative:{position:"relative"},fixed:{position:"fixed"},sticky:{position:"sticky"},static:{position:"static"},inset:(o,e=0)=>{const n=H(e);return{top:n,right:n,bottom:n,left:n}},top:(o,e=0)=>({top:H(e)}),bottom:(o,e=0)=>({bottom:H(e)}),left:(o,e=0)=>({left:H(e)}),right:(o,e=0)=>({right:H(e)}),layer:(o,e=1)=>({"z-index":e}),"":(o,e,...n)=>{if(n.length<2)throw new Error("Generic rule '::' requires at least two arguments, eg.: ::[property]:[name]");return{[n[n.length-2]]:`var(--${n.join("-")})`}},view:(o,e)=>({"view-transition-name":e})},f={min:"min-content",max:"max-content",fit:"fit-content",full:"100%"},T={portrait:"orientation: portrait",landscape:"orientation: landscape"};function H(o){return o=f[o]||o,/^-?\d+(\.\d+)*$/.test(String(o))?`${o*8}px`:o||""}let j;function X(){if(j)return j;if(l)j=new globalThis.CSSStyleSheet;else{const o=globalThis.document.createElement("style");o.appendChild(globalThis.document.createTextNode("")),globalThis.document.head.appendChild(o),j=o.sheet}return j.insertRule(":host([hidden]) { display: none; }"),j}const o1=new WeakMap;let b=new WeakSet;function _(o){const e=o.getRootNode();if(b.has(e))return;const n=X();if(l)e.adoptedStyleSheets=[...e.adoptedStyleSheets,n];else{if(e===globalThis.document)return;let a=o1.get(e);a||(a=globalThis.document.createElement("style"),e.appendChild(a),o1.set(e,a));let x="";for(let m=0;m<n.cssRules.length;m++)x+=n.cssRules[m].cssText;a.textContent=x}b.add(e)}const g=new Map;function p(o,e,n,a){let x=g.get(o);x||(x=`l-${Math.random().toString(36).substr(2,5)}`,g.set(o,x)),l||(b=new WeakSet);const m=X(),[Z,z=""]=e.split("@"),s1=Object.entries(n.replace(/\s+/g," ").trim().split(" ").reduce((F,I)=>{const[n1,...y1]=I.split(":"),U=u[n1];if(!U)throw TypeError(`Unsupported layout rule: '${n1}'`);return Object.assign(F,typeof U=="function"?U(F,...y1.map(Y=>Y.match(/--.*/)?`var(${Y})`:Y)):U)},{})).reduce((F,[I,n1])=>n1!==void 0&&n1!==""?F+`${I}: ${n1};`:F,""),f1=z.split(":").reduce((F,I)=>I===""?F:F+` and (${T[I]||`min-width: ${I}`})`,"@media screen");if(a){const F=`:host(:where(.${x}-s${Z}))`,I=`:where(.${x}-c${Z})`;[F,I].forEach(n1=>{m.insertRule(z?`${f1} { ${n1} { ${s1} } }`:`${n1} { ${s1} }`,m.cssRules.length-1)})}else{const F=`.${x}${Z}`;m.insertRule(z?`${f1} { ${F} { ${s1} } }`:`${F} { ${s1} }`,m.cssRules.length-1)}return x}var d=s(58768);const r=new WeakMap;function c(o,e){const n=(0,d.xZ)(o),a=n.startNode,x=(0,d.cc)(n.endNode);e.parentNode.insertBefore(o,e.nextSibling);let m=o,Z=a;for(;Z;){const z=Z.nextSibling;m.parentNode.insertBefore(Z,m.nextSibling),m=Z,Z=z!==x.nextSibling&&z}}function V(o,e,n,a,x){let m=r.get(e);const Z=n.map((F,I)=>({id:hasOwnProperty.call(F,"id")?F.id:I,value:F,placeholder:null,available:!0}));if(r.set(e,Z),m){const F=new Set;for(const I of Z)F.add(I.id);m=m.filter(I=>F.has(I.id)?!0:((0,d.CK)(I.placeholder),I.placeholder.parentNode.removeChild(I.placeholder),!1))}let z=e;const s1=n.length-1,f1=(0,d.xZ)(e);for(let F=0;F<Z.length;F+=1){const I=Z[F];let n1;if(m){for(let y1=0;y1<m.length;y1+=1)if(m[y1].available&&m[y1].id===I.id){n1=m[y1];break}}n1?(n1.available=!1,I.placeholder=n1.placeholder,I.placeholder.previousSibling!==z&&c(I.placeholder,z),n1.value!==I.value&&a(o,I.placeholder,I.value,n1.value,x)):(I.placeholder=globalThis.document.createTextNode(""),z.parentNode.insertBefore(I.placeholder,z.nextSibling),a(o,I.placeholder,I.value,void 0,x)),z=(0,d.cc)((0,d.xZ)(I.placeholder,{}).endNode||I.placeholder),F===0&&(f1.startNode=I.placeholder),F===s1&&(f1.endNode=z)}if(m)for(const F of m)F.available&&((0,d.CK)(F.placeholder),F.placeholder.parentNode.removeChild(F.placeholder))}function K(o,e,n){(0,d.CK)(e);const a=(0,d.xZ)(e);a.startNode=a.endNode=n,e.parentNode.insertBefore(n,e.nextSibling)}function t1(o){const e=typeof o;if(e==="object"){if(Array.isArray(o))return"array";if(o instanceof globalThis.Node)return"node"}return e}function C1(o,e,n,a,x){const m=t1(n),Z=t1(a);switch(Z!=="undefined"&&m!==Z&&(m!=="function"&&(0,d.CK)(e),Z==="array"?r.delete(e):Z!=="node"&&Z!=="function"&&(e.textContent="")),m){case"array":V(o,e,n,C1,x);break;case"node":K(o,e,n);break;case"function":x&&(n.useLayout=!0),n(o,e);break;default:e.textContent=m==="number"||n?n:""}}const Q=new WeakMap;function E1(o){return(e,n,a,x)=>{if(x){const m=Q.get(n);n.removeEventListener(o,m.get(x),x.options!==void 0?x.options:!1)}if(a){if(typeof a!="function")throw Error(`Event listener must be a function: ${typeof a}`);let m=Q.get(n);m||(m=new WeakMap,Q.set(n,m));const Z=a.bind(null,e);m.set(a,Z),n.addEventListener(o,Z,a.options!==void 0?a.options:!1)}}}function D1(o,e=new Set){if(Array.isArray(o))for(const n of o)n&&e.add(n);else if(o!==null&&typeof o=="object")for(const[n,a]of Object.entries(o))n&&a&&e.add(n);else o&&e.add(o);return e}const H1=new WeakMap;function A1(o,e,n){const a=H1.get(e)||new Set,x=D1(n);H1.set(e,x);for(const m of x)e.classList.add(m),a.delete(m);for(const m of a)e.classList.remove(m)}const $1=new WeakMap;function S1(o,e,n){if(n===null||typeof n!="object")throw TypeError(`Style value must be an object in ${(0,k.r4)(e)}:`,n);const a=$1.get(e)||new Map,x=new Map;for(const m of Object.keys(n)){const Z=(0,k.Dk)(m),z=n[m];!z&&z!==0?e.style.removeProperty(Z):e.style.setProperty(Z,z),x.set(Z,z),a.delete(Z)}for(const m of a.keys())e.style[m]="";$1.set(e,x)}function N1(o,e,n){if(e.substr(0,2)==="on"){const a=e.substr(2);return E1(a)}switch(o){case"class":return A1;case"style":return S1;default:{let a=!1;return(x,m,Z)=>{if(a=a||!n&&!(m instanceof globalThis.SVGElement)&&e in m,a)m[e]=Z;else if(Z===!1||Z===void 0||Z===null)m.removeAttribute(o);else{const z=Z===!0?"":String(Z);m.setAttribute(o,z)}}}}}const _1=(0,d.ph)("(\\d+)"),v1=new RegExp(`^${_1}$`),b1=new RegExp(_1,"g"),W1=/^[^A-Za-z]+$/;function Z1(o){let e=o[0],n=!1;for(let a=1;a<o.length;a+=1)n=n||e.match(/<\s*(table|th|tr|td|thead|tbody|tfoot|caption|colgroup)([^<>]|"[^"]*"|'[^']*')*>\s*$/),e+=(n?`<!--${(0,d.ph)(a-1)}-->`:(0,d.ph)(a-1))+o[a],n=n&&!e.match(/<\/\s*(table|th|tr|td|thead|tbody|tfoot|caption|colgroup)\s*>/);return e}function R1(o){return o.replace(/\s*=\s*['"]*$/g,"").split(/\s+/).pop()}function L1(o){return globalThis.document.createTreeWalker(o,globalThis.NodeFilter.SHOW_ELEMENT|globalThis.NodeFilter.SHOW_TEXT|globalThis.NodeFilter.SHOW_COMMENT,null,!1)}function I1(o,e=0){o=o.replace(/(^[\n\s\t ]+)|([\n\s\t ]+$)+/g,"");let n=o.indexOf(`
`);if(n>-1){let a=0-e-2;for(n+=1;o[n]===" "&&n<o.length;n+=1)a+=1;return o.replace(/\n +/g,x=>x.substr(0,Math.max(x.length-a,1)))}return o}function O1(o,e){const n=(0,d.ph)(e);return`${I1(o).split(`
`).filter(x=>x).map(x=>{const m=x.indexOf(n);return m>-1?`| ${x}
--${"-".repeat(m)}${"^".repeat(6)}`:`| ${x}`}).join(`
`).replace(b1,"${...}")}`}const P1=new Map,j1=new WeakMap;function i(o,e){const n=j1.get(o);if(!n&&!e)return;const a=e&&e.map(m=>{let Z=m;return Z instanceof globalThis.CSSStyleSheet||(Z=P1.get(m),Z||(Z=new globalThis.CSSStyleSheet,Z.replaceSync(m),P1.set(m,Z))),Z});let x;if(n){if(a&&a.length===n.length&&a.every((m,Z)=>m===n[Z]))return;x=o.adoptedStyleSheets.filter(m=>!n.includes(m))}a&&(x=(x||o.adoptedStyleSheets).concat(a)),o.adoptedStyleSheets=x,j1.set(o,a)}const h=new WeakMap;function C(o,e){let n=h.get(o);if(e){(!n||n.parentNode!==o)&&(n=globalThis.document.createElement("style"),h.set(o,n),o=(0,d.cc)(o),o.nodeType===globalThis.Node.TEXT_NODE?o.parentNode.insertBefore(n,o.nextSibling):o.appendChild(n));const a=[...e].join(`
/*------*/
`);n.textContent!==a&&(n.textContent=a)}else n&&(n.parentNode.removeChild(n),h.set(o,null))}const w=new WeakMap;function $(o,e){let n=w.get(o);n||(n=o.adoptedStyleSheets?i:C,w.set(o,n)),n(o,e)}function M(o,e,n,a){let x=globalThis.document.createElement("template");const m={},Z=n?o:Z1(o);if(x.innerHTML=e?`<svg>${Z}</svg>`:Z,e){const U=x.content.firstChild;x.content.removeChild(U);for(const Y of Array.from(U.childNodes))x.content.appendChild(Y)}let z;const s1=x.content.children[0];if(s1 instanceof globalThis.HTMLTemplateElement){for(const U of Array.from(s1.attributes)){const Y=U.value.trim();if(Y&&U.name.startsWith("layout")){if(Y.match(b1))throw Error("Layout attribute cannot contain expressions");z=p(s1,U.name.substr(6),Y,!0)}}if(z!==void 0&&x.content.children.length>1)throw Error("Template, which uses layout system must have only the '<template>' root element");a=z||s1.hasAttribute("layout"),x=s1}const f1=L1(x.content),F=[];let I=0,n1=null;for(;f1.nextNode();){let U=f1.currentNode;if(n1&&!n1.contains(U)&&(n1=null),U.nodeType===globalThis.Node.COMMENT_NODE&&v1.test(U.textContent)&&(U.parentNode.insertBefore(globalThis.document.createTextNode(U.textContent),U.nextSibling),f1.nextNode(),U.parentNode.removeChild(U),U=f1.currentNode),U.nodeType===globalThis.Node.TEXT_NODE){let Y=U.textContent;const i1=Y.match(v1);if(i1)U.textContent="",m[i1[1]]=[I,C1];else{if((0,y.eL)()&&!n&&!n1&&!Y.match(/^\s*$/)){let d1;const G=Y.trim(),e1=G.replace(/\s+/g," ").replace(b1,(l1,u1)=>(u1=Number(u1),d1===void 0&&(d1=u1),`\${${u1-d1}}`));if(!e1.match(W1)){let l1=U.previousSibling&&U.previousSibling.nodeType===globalThis.Node.COMMENT_NODE?U.previousSibling:"";l1&&(l1.parentNode.removeChild(l1),I-=1,l1=(l1.textContent.split("|")[1]||"").trim().replace(/\s+/g," "));const u1=(0,y.U2)(e1,l1).replace(/\${(\d+)}/g,(k1,M1)=>(0,d.ph)(Number(M1)+d1));Y=Y.replace(G,u1),U.textContent=Y}}const w1=Y.match(b1);if(w1){let d1=U;w1.reduce((G,e1)=>{const[l1,u1]=G.pop().split(e1);return l1&&G.push(l1),G.push(e1),u1&&G.push(u1),G},[Y]).forEach((G,e1)=>{e1===0?d1.textContent=G:(d1=d1.parentNode.insertBefore(globalThis.document.createTextNode(G),d1.nextSibling),f1.currentNode=d1,I+=1);const l1=d1.textContent.match(v1);l1&&(d1.textContent="",m[l1[1]]=[I,C1])})}}}else if(U.nodeType===globalThis.Node.ELEMENT_NODE){if(!n1&&(U.getAttribute("translate")==="no"||U.tagName.toLowerCase()==="script"||U.tagName.toLowerCase()==="style")&&(n1=U),k.$H){const Y=U.tagName.toLowerCase();Y.match(/.+-.+/)&&!globalThis.customElements.get(Y)&&!F.includes(Y)&&F.push(Y)}for(const Y of Array.from(U.attributes)){const i1=Y.value.trim(),w1=Y.name;if(a&&w1.startsWith("layout")&&i1){if(i1.match(b1))throw Error("Layout attribute cannot contain expressions");const G=p(U,w1.substr(6),i1);U.removeAttribute(w1),U.classList.add(G);continue}const d1=i1.match(v1);if(d1){const G=R1(o[d1[1]]);m[d1[1]]=[I,N1(w1,G,e)],U.removeAttribute(Y.name)}else{const G=i1.match(b1);if(G){const e1=`attr__${w1}`;for(const[l1,u1]of G.entries()){const[,k1]=u1.match(v1);let M1=!1;m[k1]=[I,(V1,m1,x1)=>{const T1=(0,d.xZ)(m1);T1[e1]=(T1[e1]||i1).replace(u1,x1==null?"":x1),(G.length===1||l1+1===G.length)&&(M1=M1||!e&&!(m1 instanceof globalThis.SVGElement)&&w1 in m1,M1?m1[w1]=T1[e1]:m1.setAttribute(w1,T1[e1]),T1[e1]=void 0)}]}Y.value=""}}}}I+=1}k.$H&&F.length&&console.warn(`Not defined ${F.map(U=>`<${U}>`).join(", ")} element${F.length>1?"s":""} found in the template:
${O1(Z,-1)}`);const y1=Object.keys(m);return function(Y,i1,w1,{styleSheets:d1}){let G=(0,d.xZ)(i1);if(x!==G.template){const e1=globalThis.document.importNode(x.content,!0),l1=L1(e1),u1=[];let k1=0,M1=0,V1=m[y1[M1]];for(;l1.nextNode();){const m1=l1.currentNode;for(;V1&&V1[0]===k1;)u1.push({index:y1[M1],node:m1,fn:V1[1]}),M1+=1,V1=m[y1[M1]];k1+=1}if(G.hostLayout&&Y.classList.remove(G.hostLayout),(0,d.CK)(i1),G=(0,d.xZ)(i1),G.template=x,G.markers=u1,i1.nodeType===globalThis.Node.TEXT_NODE){C(i1),G.startNode=e1.childNodes[0],G.endNode=e1.childNodes[e1.childNodes.length-1];let m1=i1,x1=e1.childNodes[0];for(;x1;)i1.parentNode.insertBefore(x1,m1.nextSibling),m1=x1,x1=e1.childNodes[0]}else{if(a){const m1=`${z}-${Y===i1?"c":"s"}`;Y.classList.add(m1),G.hostLayout=m1}i1.appendChild(e1)}a&&_(i1)}$(i1,d1);for(const e1 of G.markers){const l1=w1[e1.index],u1=G.prevArgs&&G.prevArgs[e1.index];if(!(G.prevArgs&&l1===u1))try{e1.fn(Y,e1.node,l1,u1,a)}catch(k1){throw console.error(`Error while updating template expression in ${(0,k.r4)(Y)}:
${O1(Z,e1.index)}`),k1}}G.prevArgs=w1}}const O=new WeakMap;function D(o,e,n=200){return function a(x,m){const Z=a.useLayout;let z;e&&(z=setTimeout(()=>{z=void 0,C1(x,m,e,void 0,Z)},n)),O.set(m,o),o.then(s1=>{z&&clearTimeout(z),O.get(m)===o&&(C1(x,m,s1,e&&!z?e:void 0,Z),O.set(m,null))})}}function P({target:o,detail:e},n){let a;switch(o.type){case"radio":case"checkbox":a=o.checked&&o.value;break;case"file":a=o.files;break;default:a=e&&hasOwnProperty.call(e,"value")?e.value:o.value}n(a)}function B(o,e){return o.split(".").reverse().reduce((n,a)=>n?{[a]:n}:{[a]:e},null)}const A=new Map;function N(o,e){if(!o)throw Error(`The first argument must be a property name or an object instance: ${o}`);if(typeof o=="object"){if(e===void 0)throw Error("For model instance property the second argument must be defined");const a=k.Qz.get(o);if(!a)throw Error("Provided object must be a model instance of the store");return e===null?()=>{a.set(o,null)}:(x,m)=>{P(m,Z=>{a.set(o,B(e,Z))})}}if(arguments.length===2)return a=>{a[o]=e};let n=A.get(o);return n||(n=(a,x)=>{P(x,m=>{a[o]=m})},A.set(o,n)),n}let W;const a1=globalThis.document&&globalThis.document.startViewTransition!==void 0&&function(e){return function n(a,x){if(W){console.warn(`${(0,k.r4)(a)}: view transition already started in ${(0,k.r4)(W)}`),e(a,x);return}e.useLayout=n.useLayout,W=a,globalThis.document.startViewTransition(()=>(e(a,x),k.gX.then(()=>{W=void 0})))}}||(o=>o);function p1(o){return this.id=o,this}function R(...o){return this.styleSheets=this.styleSheets||[],this.styleSheets.push(...o),this}function q(o,...e){this.styleSheets=this.styleSheets||[];let n=o[0];for(let a=1;a<o.length;a++)n+=(e[a-1]!==void 0?e[a-1]:"")+o[a];return this.styleSheets.push(n),this}function J(o){return this.plugins=this.plugins||[],this.plugins.push(o),this}const r1=(0,d.ph)(),c1=(0,d.ph)("svg"),h1=(0,d.ph)("msg"),B1=(0,d.ph)("layout"),z1=new Map;function U1(o,e,n,a){function x(m,Z=m){let z=a?o+h1:o.join(r1);n&&(z+=c1);const s1=x.useLayout;s1&&(z+=B1);let f1=z1.get(z);f1||(f1=M(o,n,a,s1),z1.set(z,f1)),x.plugins?x.plugins.reduce((F,I)=>I(F),()=>f1(m,Z,e,x))(m,Z):f1(m,Z,e,x)}return Object.assign(x,v)}function F1(o,...e){return U1(o,e,!1,!1)}function G1(o,...e){return U1(o,e,!0,!1)}Object.freeze(Object.assign(F1,t))},58768:(S,L,s)=>{"use strict";s.d(L,{CK:()=>y,cc:()=>k,ph:()=>E,xZ:()=>v});const t=new WeakMap;function v(u){let f=t.get(u);return f||(t.set(u,f={}),f)}function k(u){let f;for(;u&&(f=v(u))&&f.endNode;)u=f.endNode;return u}function y(u){if(u.nodeType===globalThis.Node.TEXT_NODE){const f=t.get(u);if(f&&f.startNode){const T=k(f.endNode);let H=f.startNode;const j=T.nextSibling;for(;H;){const X=H.nextSibling;H.parentNode.removeChild(H),H=X!==j&&X}t.set(u,{})}}else{let f=u.childNodes[0];for(;f;)u.removeChild(f),f=u.childNodes[0];t.set(u,{})}}const l=Date.now(),E=(u=0)=>`H-${l}-${u}`},77540:(S,L,s)=>{"use strict";s.d(L,{$H:()=>f,Dk:()=>v,N7:()=>l,Qz:()=>u,WI:()=>k,gX:()=>E,r4:()=>y});const t=new Map;function v(T){let H=t.get(T);return H===void 0&&(H=T.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),t.set(T,H)),H}function k(T,H,j={}){return T.dispatchEvent(new globalThis.CustomEvent(H,{bubbles:!1,...j}))}function y(T){return`<${String(T.tagName).toLowerCase()}>`}function l(T,H){T.nodeType===globalThis.Node.ELEMENT_NODE&&(H(T),T.shadowRoot&&l(T.shadowRoot,H));const j=globalThis.document.createTreeWalker(T,globalThis.NodeFilter.SHOW_ELEMENT,null,!1);for(;j.nextNode();){const X=j.currentNode;H(X),X.shadowRoot&&l(X.shadowRoot,H)}}const E=Promise.resolve(),u=new WeakMap,f=l.name==="walkInShadow"},13436:(S,L,s)=>{"use strict";s.d(L,{Z:()=>y});var t=s(77540);const v={string:(l,E,u)=>{const f=E?String(E):"";return f?l.setAttribute(u,f):l.removeAttribute(u),f},number:(l,E,u)=>{const f=Number(E);return l.setAttribute(u,f),f},boolean:(l,E,u)=>{const f=Boolean(E);return f?l.setAttribute(u,""):l.removeAttribute(u),f},undefined:(l,E,u)=>{const f=typeof E,T=f!=="undefined"&&v[f];return T?T(l,E,u):(l.hasAttribute(u)&&l.removeAttribute(u),E)}},k={string:(l,E)=>l.getAttribute(E),number:(l,E)=>Number(l.getAttribute(E))||0,boolean:(l,E)=>l.hasAttribute(E),undefined:(l,E)=>l.getAttribute(E)};function y(l,E){const u=typeof E.value,f=v[u],T=k[u];if(!f)throw TypeError(`Invalid default value for '${l}' property - it must be a string, number, boolean or undefined: ${u}`);const H=(0,t.Dk)(l);return{get:(j,X)=>X===void 0?T(j,H)||E.value:X,set:(j,X)=>f(j,X,H),connect:u!=="undefined"?(j,X,o1)=>(!j.hasAttribute(H)&&j[X]===E.value&&(j[X]=f(j,E.value,H)),E.connect&&E.connect(j,X,o1)):E.connect,observe:E.observe}}}},K1={};function g1(S){var L=K1[S];if(L!==void 0)return L.exports;var s=K1[S]={exports:{}};return X1[S](s,s.exports,g1),s.exports}g1.d=(S,L)=>{for(var s in L)g1.o(L,s)&&!g1.o(S,s)&&Object.defineProperty(S,s,{enumerable:!0,get:L[s]})},g1.o=(S,L)=>Object.prototype.hasOwnProperty.call(S,L),g1.r=S=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(S,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(S,"__esModule",{value:!0})};var Y1={};(()=>{"use strict";var S=g1(90384),L=g1(96806),s=g1(77540);const t=new WeakMap,v=new WeakMap;function k(b,_){const g=v.get(b);if(g===_)return;const p=S.Z.compile(_);v.set(b,_),t.has(b)&&t.get(b)(),t.set(b,()=>{p.prototype.disconnectedCallback.call(b);for(const[r]of d)delete b[r];t.delete(b)});const d=Object.entries(Object.getOwnPropertyDescriptors(p.prototype));p.prototype.connectedCallback.call(b);for(const[r,c]of d)if(!(r==="constructor"||r==="connectedCallback"||r==="disconnectedCallback")&&(Object.defineProperty(b,r,{...c,configurable:!0}),g)){const V=typeof _[r],K=V!=="object"&&V!=="function"&&_[r]!==g[r];K&&b.removeAttribute((0,s.Dk)(r)),(0,L.z6)(b,r,{clearValue:K})}}var y=g1(72020),l=g1(9664);S.Z.from(function(){const b=[],_=[];var g=function(){const p=g1(23998),d={};return p.keys().forEach(function(r){const c="./components/"+r.replace("./","");!b.includes(c)&&!_.includes(c)&&(_.push(c),d[c]=function(){const V=p(r);return Object.prototype.toString.call(V)==="[object Module]",V.default}())}),d}();return Object.assign(g)}(),{prefix:"ui",root:"components"}),S.Z.from(function(){const b=[],_=[];var g=function(){const d=g1(86782),r={};return d.keys().forEach(function(c){const V="./components/"+c.replace("./","");!b.includes(V)&&!_.includes(V)&&(_.push(V),r[V]=function(){const K=d(c);return Object.prototype.toString.call(K)==="[object Module]",K.default}())}),r}(),p=function(){const d=g1(72782),r={};return d.keys().forEach(function(c){const V="./views/"+c.replace("./","");!b.includes(V)&&!_.includes(V)&&(_.push(V),r[V]=function(){const K=d(c);return Object.prototype.toString.call(K)==="[object Module]",K.default}())}),r}();return Object.assign(g,p)}(),{prefix:"ui-autoconsent",root:["components"]});function E(b,_="440px"){const g=document.createElement("ghostery-iframe-wrapper"),p=g.attachShadow({mode:"closed"}),d=document.createElement("template");d.innerHTML=`
  ...
  `,p.appendChild(d.content),document.documentElement.appendChild(g);const r=p.querySelector("iframe");setTimeout(()=>{r.classList.add("active")},100),window.addEventListener("message",c=>{var V;switch((V=c.data)==null?void 0:V.type){case"ghostery-resize-iframe":{const{height:K,width:t1}=c.data;r.style.height=K+"px",t1&&(r.style.width=t1+"px");break}case"ghostery-close-iframe":c.data.clear&&chrome.runtime.sendMessage({action:"clearIframe",url:b}),c.data.reload?window.location.reload():setTimeout(()=>g.parentElement.removeChild(g),0);break;case"ghostery-clear-iframe":r.src===c.data.url&&setTimeout(()=>g.parentElement.removeChild(g),0);break;default:break}})}function u(b=!1,_=!1){setTimeout(()=>{window.parent.postMessage({type:"ghostery-close-iframe",reload:b,clear:_},"*")},100)}function f(b){new ResizeObserver(()=>{window.parent.postMessage({type:"ghostery-resize-iframe",height:document.body.clientHeight,width:b},"*")}).observe(document.body,{box:"border-box"}),document.body.style.overflow="hidden",chrome.runtime.onMessage.addListener(g=>{g.action==="clearIframe"&&(console.log("clearIframe",g.url),window.parent.postMessage({type:"ghostery-clear-iframe",url:g.url},"*"))})}const T=new URLSearchParams(window.location.search).get("host");f();async function H(b,_){const{all:g}=_.detail;chrome.runtime.sendMessage({name:"enable",origin:"autoconsent",message:{url:g?void 0:T}})}async function j(b,_){const{all:g}=_.detail;chrome.runtime.sendMessage({name:"disable",origin:"autoconsent",message:{url:g?void 0:T}})}function X(b,_){u(_.detail.reload)}async function o1(){const b=await new Promise(r=>{chrome.runtime.sendMessage({name:"getTabInfo"},r)}),{summary:_}=await new Promise(r=>{chrome.runtime.sendMessage({name:"getPanelData",message:{view:"panel",tabId:b.id}},r)}),{antiTracking:g,adBlock:p}=await new Promise(r=>{chrome.runtime.sendMessage({name:"getCommonModuleData",message:{tabId:b.id}},r)}),d=_.categories.reduce((r,c)=>{for(let V=0;V<c.num_total;V+=1)r.push(c.id);return r},[]);for(let r=0;r<p.unidentifiedTrackerCount;r+=1)d.push("unknown");for(let r=0;r<g.trackerCount;r+=1)d.push("advertising");return d}k(document.body,{categories:{value:void 0,connect:(b,_)=>{let g;const p=async()=>{b[_]=await o1(),g=setTimeout(p,1e3)};return g=setTimeout(p,1e3),()=>clearTimeout(g)}},content:({categories:b})=>y.dy`
		<ui-autoconsent
			categories="${b}"
			onenable="${H}"
			ondisable="${j}"
